...
<script type="text/html" id="tmpl-upload-sliders">
	<div id="ls-upload-modal-window">
		...
		<form method="post" enctype="multipart/form-data" class="km-ui-modal-scrollable">
			...
			<div class="ls-notification updated info"><div><?php _e('Looking for the importable demo content? Check out the <a href="#" class="ls-open-template-store" data-delay="750"><i class="dashicons dashicons-star-filled"></i>Template Store</a>.', 'LayerSlider') ?></div></div>
